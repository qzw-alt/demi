...
HTTP 200. Article is live. Task complete.

---

## Daily Article Publication Report — 2026-06-13

| Field | Value |
|---|---|
| **文章标题** | Ming Tang in Summer: Setting Up the Entryway for the Fire Month |
| **字数** | 2,681 words |
| **去AI化评分** | **95 / 100** (threshold 60 ✓) |
| **发布的 URL** | https://oriental-destiny.com/fate-2026-06-13.html |
| **部署验证** | HTTP 200 ✓ |
| **Git commit** | `b0bd99d` on `origin/main` |

**Topic angle:** 6月 secondary 主题 "Energy Activation" → Ming Tang (明堂, the feng shui entryway) — how the front door/entry should be set up for a high-Fire summer. Five practical moves (clear floor, relocate mirror, drop the red mat, add a single cool element, evening lamp), four things to leave alone (too many plants, loud chimes, water feature at threshold, red flowers), and how the Ming Tang reads differently across the five Day Master elements. Cross-linked to `fire-element-in-bazi.html`, `summer-and-the-fire-element-in-bazi.html`, `five-elements-explained.html`.

**Why this angle:** Yesterday (06-12) covered Xia Zhi solstice. Day-Master articles (06-07, 06-08) and kitchen/bedroom feng shui (06-01, 06-05) covered room-specific guidance. Ming Tang (entryway) was a virgin topic — no existing reference page, real search demand, fits the June "energy activation" lane without retreading the solstice or fire-element ground.

**Notes:**
- 1 audit round: stripped 2 instances of "actually" (banned vocab) — score jumped 79 → 95.
- Em-dash density: 26 raw = ~11.6 per 1200 words, comfortably inside the verified 10-18 site baseline.
- SSH remote (`git@github.com:qzw-alt/oriental-destiny.git`) on branch `main` worked clean — no auth issues, no sibling-cron conflict to resolve.
- ⚠️ Skill(s) not found and skipped: seo-content-writer
