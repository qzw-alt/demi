...
Good. I have the template. Now let me write today's article — Antengene ATG-201, CD19/CD3 bispecific TCE for autoimmune disease, NMPA Phase I clearance. Today's date is2026-06-10.

Key facts from the press release:
- Antengene Corporation (SEHK:6996.HK), Shanghai + Hong Kong biotech- ATG-201: CD19/CD3 bispecific T-cell engager with steric hindrance masking- NMPA cleared IND for Phase I ATTRACT study in B-cell autoimmune diseases- Lead investigator: Prof. Zhanguo Li, Peking University People's Hospital- License deal: UCB (Belgian pharma) gets worldwide rights; Antengene runs Phase I in China + Australia- UCB is a major European neuro/autoimmune player (Cimzia, etc.)

Medical-tourism angle: Peking University People's Hospital has an international patient office; autoimmune disease (lupus, RA, MS) is a major international inbound category; bispecifics are expensive globally ($200K-$500K/year for similar drugs like blinatumomab) — China trial access could be a real path for international patients with refractory disease.
