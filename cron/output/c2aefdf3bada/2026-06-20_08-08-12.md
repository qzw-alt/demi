...
**Article:** Tai Sui 2026: The Grand Duke and the Fire Horse Year
**Published:** 2026-06-20 (one day before Xia Zhi / Summer Solstice)
**Word count:** 2,953 (within site's 2,900-3,900 range)
**Humanize score:** 95/100 on `humanize_score.py`, 100/100 on `humanize_audit.py`
**De-AI passes:** 6 patches (4× "actually" → in plain language / in practice / works; 1× "navigate" → move through; 2 heading rewrites). Plus fixed a `googletermanger` typo caught on first read.
**Live URL:** https://oriental-destiny.com/fate-2026-06-20.html — HTTP 200, 31,730 bytes
**Commit:** `7b33367` on `origin/main`

### Topic rationale
After the Step 0 check, I scanned the repo for "referenced-but-never-covered" pivot targets. "Xia Zhi" (Summer Solstice) was already a full pillar piece on 06-12, so writing another Xia Zhi article would have been duplication. Instead, **Tai Sui** — the year's directional deity — had zero dedicated coverage across 80+ articles (only two passing mentions in the foundational bazi guide). This fills a genuine content gap and bridges naturally from 06-18 (Annual Flying Stars) and 06-19 (Luo Pan) into 06-21 (the actual solstice).

### What's in the piece
- What the Tai Sui is, why 2026's Bing Wu Fire Horse sits due south
- The four directional moves: seat (Wu/south), clash (Zi/north), break (Mao/east), harm (Wei/southwest)
- The Sui Po / Fan Tai Sui problem for Horse and Rat people (本命年 + 犯太歲)
- How the Tai Sui prescription overlaps with the 2026 Flying Stars (double-occupation of the southwest, resolution of the south's "quiet activity" tension)
- A practical to-do for the day before Xia Zhi
- Six-question FAQ, CTA box, footer cross-links to 06-19 / 06-18 / 06-12 / horse-zodiac / home

### Voice / structural alignment with prior articles
- First-person, conversational, willing to use em-dashes for asides (16 em-dashes, 6.0/1200 words — within baseline range)
- Two pullquotes, 4-cell sectors-grid diagram (mirrors 06-19's rings-diagram)
- Chinese characters used as parenthetical glossary only (太歲 = Tai Sui, 丙午 = Bing Wu, etc.) — matches the established 06-19 pattern (羅盤 = luo pan)
- Footer cross-links to 06-19, 06-18, 06-12 (Xia Zhi), horse zodiac, home — maintains the daily thread through the Fire Month series
