...
All done. Article is live, sitemap updated, news index updated, push succeeded, HTTP 200 verified, recovery handoff note saved for the next run.

---

## 2026-06-09 Cron Run Report

**热点标题:** Ori-C101 GPC3 CAR-T for Liver Cancer: NMPA Clears First Global Confirmatory Phase II Trial in HCC (June 2026)

**核心故事:** 2026年6月8日，上海 Oricell Therapeutics 的 Ori-C101（GPC3 靶向自体 CAR-T）获中国 NMPA 批准进入**全球首个 GPC3 实体瘤 CAR-T 确证性 II 期临床试验**，适应症为二线以上治疗失败的晚期肝细胞癌（HCC）。BEACON I 期研究（2026 ASCO 口头报告）显示 RP2D 剂量 ORR 达 66.7%，中位总生存期 21.4 个月（vs. 历史 10.6 个月）。

**关键信息点:**
- 66.7% ORR at RP2D / 100% at DL4 (Phase I BEACON, ASCO 2026 oral)
- 21.4-month median OS vs. 10.6-month historical benchmark
- First GPC3 CAR-T ever in confirmatory Phase II; first liver-cancer CAR-T in randomized Phase II
- China: 410,000 new HCC cases / 317,000 deaths per year
- 24-month durable complete response in 1 patient (Phase I)

**原始来源:** 
- Oricell press release via PR Newswire / manilatimes (2026-06-08, 2026-06-01)
- ASCO 2026 BEACON data
- Oricell Series C / pre-IPO announcements

**字数:** 4,216 words
**去AI化评分:** 82/100 (阈值 60) — 1 处 "actually" 为临床语境中的合法用法，按 2026-06-08 验证的已知误报忽略
**em-dash 密度:** 16.6/1200 词 (64 个原始 em-dash) — 接近 17-23 基线下沿
**发布 URL:** https://chinahospitalsguide.com/news/2026-06-09-oricell-gpc3-cart-hcc-nmpa-phase2-clearance.html
**验证状态:** HTTP 200, 36,485 bytes
**Commit:** fc91607
**Git Push:** 成功（SSH 远程仍有效）

**Handoff:** 已写入 `references/pending-2026-06-09-oricell-gpc3-cart-hcc.md`，记录今日完整研究/写作/发布路径 + HCC/liver-cancer 主题后续选题建议，供下一轮 cron 参考。
