...
All done. Article shipped, sitemap updated, news index updated, commit `9966cd8` pushed, HTTP 200 verified. Here's the report:

---

## 📰 2026-06-11 Cron Report

**Story shipped:** Antengene ATG-201 CD19 × CD3 bispecific T-cell engager for B-cell autoimmune disease — NMPA IND clearance for Phase I ATTRACT study at Peking University People's Hospital

### Recovery handoff worked end-to-end
The 2026-06-10 cron was killed mid-research after only ~8 tool calls, so a `pending-2026-06-10-antengene-atg201-...md` file was saved with the full research recipe, internal/external link targets, em-dash target, and 9-section structure. This 2026-06-11 run picked it up, wrote the article from the recipe in ~7 tool calls, and shipped it under the original 06-10 story date (preserves freshness — Antengene press release is 1 day old, not 2).

### Article stats
- **Title:** Antengene ATG-201: China's First CD19 × CD3 Bispecific T-Cell Engager Cleared by NMPA for B-Cell Autoimmune Disease
- **Word count:** 5,229 (em_dash_check reports 5,638 with broader regex)
- **Em-dash density:** 13.4 per 1200 words (raw 63) — in the verified 10-17 false-negative band; left as-is per the SKILL.md pitfall
- **Humanize score:** **62/100** ✅ (passes >60 threshold)
- **Sections:** 9 (matching the 06-09 Ori-C101 pattern)
- **Internal links:** 3 (Ori-C101 06-09, Jiahui 06-06, Hainan Lecheng 06-03)
- **External sources:** 11 (Antengene PR, manilatimes mirror, Antengene corporate, PKUPH, CDE, UCB, academic CAR-T-for-lupus background, blinatumomab PI)

### Publish details
- **File:** `news/2026-06-10-antengene-atg-201-bispecific-autoimmune-pku.html`
- **Commit:** `9966cd8` on master
- **Sitemap updated:** entry added before 2026-06-09
- **News index updated:** card added at top
- **Live URL:** https://chinahospitalsguide.com/news/2026-06-10-antengene-atg-201-bispecific-autoimmune-pku.html
- **Verification:** HTTP 200 at T+3 min after push (article, sitemap, news index all 200)
- **Pending note for archive:** `references/pending-2026-06-11-antengene-atg201-shipped.md` documents the recipe + commit hash + pitfalls encountered

### Banner
Teal/blue gradient (autoimmune / bispecific, distinct from oncology purple used in 06-09 CAR-T story) — matches the suggestion in the original pending file.
