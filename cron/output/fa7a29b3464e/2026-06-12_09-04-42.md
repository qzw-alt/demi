...
```
RuntimeError: # Cron Run Summary — 2026-06-12

## Status: Recovery Cycle Handoff

I researched extensively and identified a strong story, but exhausted the tool-call budget before I could write the article, humanize, publish, and push it. I'm handing the research off via a pending file for the next cron run to pick up.

## Research Completed

**Story selected:** Business Times / Bloomberg syndication — "China's nascent medical tourism lures foreign patients with cutting-edge, cheap medical care" (Business Times, 2026-06-11 09:02 SGT; syndicated to MSN, AP, Yahoo Finance; sourced from Bloomberg).

**Why this story:**
- Fresh: published yesterday, 2026-06-11
- High-signal source: Business Times Singapore + Bloomberg wire
- New angle not covered by recent chinahospitalsguide articles — the BT piece carries data points absent from the 2026-04-18 and 2026-06-06 SinoUnited pieces: the Stuart Lye / New Zealand patient narrative, the May 2026 clinical-trial-fee ban, China's March 2026 brain-implant milestone, the $1.3B → $3.4B 2025→2035 market projection, and a direct comparison vs Thailand/Singapore/US
- Connects cleanly to medical tourism themes (CAR-T, advanced procedures, cost arbitrage, regulation, international patient path)

**Key facts to use:**
- Stuart Lye, 58, NZ high-risk myeloma patient; 2018 diagnosis, 3-month prognosis; traveled to Shanghai for CAR-T clinical trial; 7 weeks of treatment, US$65,000 all-in (vs A$500,000 in Australia)
- SinoUnited Health, Shanghai: ~30 foreign CAR-T patients since late 2024; CEO Shi Haoying
- Victor Cao, Joyful Medical agency, Shanghai — facilitates international cancer-patient access
- US CAR-T: $300,000–$475,000/infusion; China: $150,000–$180,000; one therapy aimed at sub-300,000 yuan (S$57,036)
- 7 approved commercial CAR-T products in China (matches US); China leads world in CAR-T clinical-trial count (ClinicalTrials.gov)
- Global medical tourism market: US$34B → US$126B by 2035 (Grand View Research)
- China market: US$1.3B (2025) → US$3.4B (2035) (Market Research Future)
- McKinsey: by 2024, China at parity with US in experimental medicines entering clinical testing; trials 2-5x faster
- 2024: China first to use homegrown cell therapy for pediatric lupus; 2025: Asia's first cross-species kidney transplant; March 2026: world's first commercial brain-implant approval (spinal cord injury)
- May 2026: China banned hospitals from charging clinical-research fees; allowed qualified hospitals to commercialize cell therapy, BCI, xenotransplantation without traditional drug registration
- Lecheng International Medical Tourism Pilot Zone (Hainan): designated 2013; "just a few thousand foreign medical tourists last year" vs "hundreds of thousands of domestic patients"
- Jeroen Groenewegen-Lau (Mercator Institute) and Zhao Bing (China Renaissance Securities) commentary
- Skeptical voices: Jacob Becraft (Strand Therapeutics), Zhao on Thailand/Singapore competition, lack of dedicated medical visa, fragmented services

**Source URLs:**
- Primary: https://www.businesstimes.com.sg/international/global/chinas-nascent-medical-tourism-lures-foreign-patients-cutting-edge-cheap-medical-care (Business Times, 2026-06-11)
- PR Newswire mirror (China Daily / Lecheng service center angle, 2026-06-11): https://www.prnewswire.co.uk/news-releases/lecheng-launches-service-center-for-international-medical-tourism-302797757.html

## Files Created

1. **`/home/ubuntu/.hermes/skills/creative/content-research-writer-cn/references/pending-2026-06-12-china-medical-tourism-global-arbitrage.md`** — full recovery handoff with facts, suggested 9-section structure, internal link targets (existing 2026-04-18 CAR-T article, 2026-06-06 Pakistani CAR-T piece, 2026-06-03 Lecheng zone article, 2026-06-10 Antengene ATG-201), and em-dash target (17-23/1200)

2. **`/home/ubuntu/.hermes/workspace/website/.hermes/tmp/lecheng-research/`** — cached raw fetches (bt1.html 218KB, lecheng.html 183KB) for the next run to skip the research step

## What The Next Cron Run Should Do

1. Read `/home/ubuntu/.hermes/skills/creative/content-research-writer-cn/references/pending-2026-06-12-china-medical-tourism-global-arbitrage.md`
2. Target article filename: **`2026-06-11-china-medical-tourism-cutting-edge-cheap-bloomberg.html`** (date = press release date, not cron run date, per the verified 2026-06-11 rule)
3. Write 9-section article using BT body quotes as primary source
4. Humanize, commit on `article-2026-06-11` branch, push to `origin/master`, verify HTTP 200

## Working Tree State

- Branch: `master`, clean
- Remote: `git@github.com:qzw-alt/chinahospitalsguide.git` (SSH, durable)
- Last shipped article: `2026-06-10-antengene-atg-201-bispecific-autoimmune-pku.html`
- SSH fix from 2026-06-07 cron is still in place

The research and handoff are complete — the next cron run will be a clean recovery cycle.
```
