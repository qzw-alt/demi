...
2. 筛选1-2个有价值的选题
3. 按照博客写作标准流程创建新闻文章
4. **关键步骤：更新 news/index.html 索引页**
   - 读取 /root/.openclaw/workspace/chinahospitalsguide/news/ 目录下所有新闻文件
   - 按日期排序（最新的在前）
   - 更新 news/index.html 中的 news-list 区域
   - 确保每篇文章都包含：日期、标题、摘要、图片、链接
5. 提交并推送到 GitHub

质量标准：
- 宁缺毋滥，没有好热点则不发
- 必须用 NewsArticle Schema
- 去AI化评分>60才能发布
- 每次更新必须同步更新索引页
...
### 执行摘要
2026年4月26日医疗新闻写作任务已完成。从近24小时热点中筛选出**韩国医疗旅游突破200万患者、84亿美元**的高价值选题，已完成文章撰写、索引页更新和GitHub推送。
...
| 步骤 | 状态 | 说明 |
|------|------|------|
| 1. 搜索热点 | ✅ | DuckDuckGo搜索获取近24小时医疗旅游新闻 |
| 2. 筛选选题 | ✅ | 选定韩国200万医疗游客/$8.4B为最佳选题 |
| 3. 文章撰写 | ✅ | 完成去AI化、NewsArticle Schema、中韩对比表格 |
| 4. 更新索引 | ✅ | news/index.html已添加新文章条目 |
| 5. GitHub推送 | ✅ | 已提交并推送到origin/master |

---

### 发布文章

**标题：** South Korea's Medical Tourism Hits 2 Million Patients and $8.4B — How Does China Compare?

**文件：** `news/2026-04-26-south-korea-medical-tourism-2-million-84b-china-compare.html`

**核心内容：**
- 韩国2025年接待201万外国医疗患者，同比增长72%，总消费约84亿美元
- 中国同期接待41万入境医疗游客，同比增长38%
- 详细中韩对比表格（患者量、增长率、核心专科、成本、等待时间、传统医学等9个维度）
- 分析两国不同定位：韩国主导医美/体检，中国主导CAR-T/质子治疗/复杂肿瘤

**质量标准检查：**
- ✅ NewsArticle Schema markup
- ✅ 去AI化写作（避免AI词汇、被动语态、填充短语）
- ✅ 具体数据来源（韩国保健福祉部、KIET、Korea JoongAng Daily等）
- ✅ 观点鲜明，有分析深度
...
```
commit d764536
news: South Korea medical tourism hits 2M patients, $8.4B — China comparison

- New article: 2026-04-26-south-korea-medical-tourism-2-million-84b-china-compare.html
- Updated news/index.html with new article entry
- NewsArticle Schema markup included
- Sources: Korea Ministry of Health, KIET, Korea JoongAng Daily
```

已推送至 `https://github.com/qzw-alt/chinahospitalsguide.git` master分支。
