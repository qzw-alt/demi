...
**Known-failed token — qzw-alt/demi repo:** PAT `github_pat_REDACTED_LEAKED_TOKEN` returned 401 from `GET /user` (backup session 2026-06-15). Token is invalid or revoked — regenerate before next backup attempt.
