...
## Absorbed Skills (Session-Specific Detail)

The following skills have been consolidated here as reference documents:

- [blog-content-writer](./references/blog-content-writer.md) — Long-form blog article workflow for China Hospitals Guide; 10-section structure, refresh procedure, competitor-gap workflow
- [news-writing-template](./references/news-writing-template.md) — Medical tourism news article writing template; headline formulas, de-AI checklist, publishing workflow
- [content-research-pipeline](./references/content-research-pipeline.md) — Research → write → humanize pipeline for blog/news articles; standard workflow for the medical tourism blog project
- [china-hospitals-guide-workflow](./references/china-hospitals-guide-workflow/) — China Hospitals Guide site deployment, news writing standards, backup procedures, competitor gap analysis, sitemap management
- [website-seo-operations](./references/website-seo-operations.md) — Google Search Console troubleshooting, sitemap indexing, Oriental Destiny SEO project details
