...
- `references/2026-07-22-session-notes.md` — clean run: 7th CJK miss confirmed, 4th tvly- miss confirmed, 7th gitignore-wipe confirmed (unconditional rewrite at end of step 3 holds), AIza-in-submodule verified informational (no redaction needed), staged-blob scan defense confirmed working, cron-prompt dead-PAT escalation count now 6 consecutive runs
